...
try:
    ...
    for notice in notice_list:
        ...
        if check == 1: # 있을 경우
            ...
            link = "https://knucube.knu.ac.kr/site/reservation/lecture/" + href.replace("./", "")
